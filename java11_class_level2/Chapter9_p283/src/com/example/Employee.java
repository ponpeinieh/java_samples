...
public class Employee {
    ...
    public static class Builder {
        ...
        //
        public Employee.Builder skills(List<String> val) {
            skills = val;
            return this;
        }
    ...
    public static List<Employee> createShortList() {
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("KS")
                        .code("12333")
                        .skills(List.of("Computer","Driving","Language"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("KS")
                        .code("12333")
                        .skills(List.of("Cooking","Bakering"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("KS")
                        .code("12333")
                        .skills(List.of("Computer","Designing","Social"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("MA")
                        .code("11111")
                        .skills(List.of("Acting","Swimming","Golfing"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("MA")
                        .code("11111")
                        .skills(List.of("Computer","Negotiating"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("CO")
                        .code("11111")
                        .skills(List.of("Writing","Singing","Language"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("CO")
                        .code("222333")
                        .skills(List.of("Computer","Investing","Snooker"))
                        .build()
        );
        ...
        people.add(
                new Employee.Builder()
                        ...
                        .state("CO")
                        .code("222333")
                        .skills(List.of("Joking","Singing","Guitar"))
                        .build()
        );
