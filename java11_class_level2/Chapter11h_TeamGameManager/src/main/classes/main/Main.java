...
import static utils.Settings.dirName;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String teamNames = "Robins, Pelicans, Sparrows, Magpies, Crows, Falcons";
        ...
        League theLeagueCompetition = new League(gameType, theTeams);

        // Create and play all games using these teams
        theLeagueCompetition.createAndPlayAllGames();
        storage.JacksonUtil.saveToJSONFile(dirName, "leagueSoccer01.json", theLeagueCompetition.getGames());
        //
        Game[] newGames = storage.JacksonUtil.getGamesFromJSONFile(dirName, "leagueSoccer01.json");
